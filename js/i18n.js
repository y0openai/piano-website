...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.portfolio.h2': 'Beyond crypto,<br>under the same rules.',
    ...
    ko: {
      ...
      'index.pixel.garden.p': '코인 시장만 보면 흐름이 바뀔 때 전략도 크게 흔들릴 수 있습니다. Piano는 금, 원유, ETF, AI 관련 주식까지 함께 살펴보고, 사용자가 정한 조건 안에서 리스크를 나눠 관리하게 돕습니다.',
      ...
      'index.portfolio.h2': '코인만 보지 않아도 돼요.<br>같은 조건으로 정리할 수 있어요.',
