...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.hero.badge': 'Two-way hedge (delta-neutral)',
      'index.hero.sub': 'Up or down, hedge both sides — executed only within the limits your rules set.',
      ...
      'index.strat.label': 'Strategy classification',
      'index.strat.h2': 'Not a hunch —<br>a defined strategy class.',
      'index.strat.sub': 'The way PIANO operates belongs to a well-established institutional strategy family — and the same tool is applied identically for every user.',
      'index.strat.c1': 'Two-way hedge', 'index.strat.c1tag': 'delta-neutral',
      'index.strat.c2': 'No directional bet', 'index.strat.c2tag': 'market-neutral',
      'index.strat.c3': 'Capture the spread', 'index.strat.c3tag': 'basis & funding carry',
      'index.strat.c4': 'Runs by rules', 'index.strat.c4tag': 'rule-based / systematic',
      'index.strat.c5': 'Auto-correct within limits', 'index.strat.c5tag': 'rebalancing',
      'index.strat.note': 'Classification describes how the tool works; it does not guarantee returns. The same tool is provided to every user.',

      'index.track.label': 'Track record',
      'index.track.h2': 'Real results,<br>from the running tool.',
      'index.track.sub': 'The figures below are the actual performance of one live account running two configurations (delta/gamma). Past results do not guarantee future returns.',
      'index.track.roi': 'Return (account)',
      'index.track.winrate': 'Win rate',
      'index.track.trades': 'Closed trades',
      'index.track.periodLabel': 'Measurement period',
      'index.track.daysUnit': ' days',
      'index.track.disclaimer': 'These are realized past results of a single live account running two configurations (delta/gamma), losses included. Return is the account’s time-weighted return (TWR) over the measurement period — a method that removes the effect of deposits and withdrawals; win rate and trade count cover both configurations and count individual hedge legs. Past performance, backtests, and simulations do not guarantee future returns, and you may lose principal. The same tool is provided to every user.',
      ...
      'index.pixel.market.p': 'Commodity, ETF, stock-linked, and crypto futures become routes on one map. The animation makes supported assets feel discoverable instead of technical.',
      'index.pixel.garden.label': 'All-Weather Logic',
      'index.pixel.garden.h3': 'Different drivers,<br>one risk view',
      'index.pixel.garden.p': 'Gold, oil, ETFs, AI stocks, and crypto can react to different market forces. The garden scene turns diversification into a calm, memorable visual story.',
      ...
      'index.bridge.aria': 'Four things stocks and ETFs do not reach',
      'index.bridge.label': 'Four things stocks and ETFs do not reach',
      'index.bridge.h2': 'Beyond reach:<br>markets, directions, hours, currencies',
      'index.bridge.sub': 'One way to diversify<br>You set the assets, conditions, and limits',
      'index.bridge.c1.kicker': '01 / Global diversification',
      'index.bridge.c1.h3': 'US, Japan, commodities —<br>all in one account.',
      'index.bridge.c1.p': 'Same approach you used with S&P 500 for the US or Nikkei ETFs for Japan. Global assets, one screen.',
      'index.bridge.c2.kicker': '02 / Like inverse ETFs',
      'index.bridge.c2.h3': 'Up days and down days,<br>without leaning to one side.',
      'index.bridge.c2.p': 'Similar to using inverse ETFs to cushion drawdowns. Hedging and diversifying happen within the conditions you set in advance.',
      'index.bridge.c3.kicker': '03 / 24 hours',
      'index.bridge.c3.h3': 'A 24-hour market,<br>without waking at night.',
      'index.bridge.c3.p': "When the US market opens in the middle of the night in Korea, the alarm rings but the hand doesn't move. Set conditions and limits in advance — the tool moves only within them, even while you sleep.",
      'index.bridge.c4.kicker': '04 / Currency diversification',
      'index.bridge.c4.h3': 'USDT-based trading<br>moves with the US dollar.',
      'index.bridge.c4.p': "USDT is a stablecoin pegged to the US dollar. Assets you hold in USDT follow the dollar's price flow, giving you a way to hold assets in a unit other than KRW. The peg can vary depending on issuer trust.",

      'index.portfolio.label': 'A wider universe',
      'index.portfolio.h2': 'Beyond one familiar market,<br>under the same rules.',
      'index.portfolio.sub': 'Gold, oil, ETF-linked and stock-linked futures move for different reasons. Piano only brings the instruments you have selected into the same condition-based view.',
      ...
      'index.portfolio.c4.h3': 'Basis hedge remains a core strategy',
      ...
      'index.features.label': 'What runs inside',
      'index.features.h2': 'Three jobs inside<br>the same rule flow',
      'index.features.sub': 'After setup, these mechanisms check conditions, correct drift, and execute only within the boundaries you define.',
      ...
      'index.hiw.h2': 'Your rules, executed automatically',
      ...
      'index.hiw.s1.p': "You pick the assets Piano will watch. Piano doesn't recommend any asset or judge what's right for you.",
      'index.hiw.s2.time': 'Set',
      'index.hiw.s2.h3': 'Build conditions and limits',
      'index.hiw.s2.p': 'Define entry conditions, exit conditions, risk limits, and position size. The condition filter only checks whether your rules are met.',
      'index.hiw.s3.time': 'Run',
      'index.hiw.s3.h3': 'Execute and correct inside the boundary',
      'index.hiw.s3.p': 'After you approve API permissions, Piano monitors, places orders, and corrects ratio drift only inside your configured conditions. Execution history stays visible on the dashboard.',
      ...
      'index.sec.c5.h3': 'You decide every condition',
      'index.sec.c5.p': 'You set every condition yourself and can change them anytime',
      'index.sec.c6.h3': 'Isolated Environment',
      'index.sec.c6.p': 'Each user runs in a separated environment',
      ...
      'index.pricing.note': 'Pricing varies by operating environment and is shared on request.',
      ...
      'index.faq.q5.a': 'Piano focuses on Binance-connected instruments, including crypto markets and futures that track commodities, ETF-linked indices, and selected global stocks. These are derivative contracts, not ownership of the underlying asset. Product availability depends on exchange listings and user approval.',
    ...
    ko: {
      ...
      'index.hero.badge': '양방향 헷지(델타 뉴트럴)',
      'index.hero.sub': '오르든 내리든 양쪽을 함께 잡는 헷지 — 사용자가 정한 규칙 안에서만 실행돼요.',
      ...
      'index.hero.story4.a': '설정해두면, 가격은 조건이 지켜봐요.',
      ...
      'index.strat.label': '전략 분류',
      'index.strat.h2': '감(感)이 아니라,<br>정의된 전략 분류.',
      'index.strat.sub': 'PIANO가 작동하는 방식은 기관이 오래 써 온 잘 알려진 전략군에 속합니다. 그리고 모든 사용자에게 동일한 도구가 동일하게 적용됩니다.',
      'index.strat.c1': '양방향 헷지', 'index.strat.c1tag': '델타 뉴트럴',
      'index.strat.c2': '한쪽에 베팅 안 함', 'index.strat.c2tag': '시장 중립',
      'index.strat.c3': '가격차를 수취', 'index.strat.c3tag': '베이시스·펀딩 캐리',
      'index.strat.c4': '규칙대로 실행', 'index.strat.c4tag': '룰베이스 시스테매틱',
      'index.strat.c5': '한도 안에서 자동 보정', 'index.strat.c5tag': '리밸런싱',
      'index.strat.note': '분류는 작동 방식을 설명할 뿐, 수익을 보장하지 않습니다. 모든 사용자에게 동일한 도구가 제공됩니다.',

      'index.track.label': '운용 실적',
      'index.track.h2': '실제 성과를,<br>돌아가는 도구에서 그대로.',
      'index.track.sub': '아래 숫자는 실제로 운용 중인 계좌 한 개(라흐마니노프 — 델타/감마 두 설정)의 성과입니다. 과거 실적은 미래 수익을 보장하지 않습니다.',
      'index.track.roi': '수익률 (계좌 기준)',
      'index.track.winrate': '승률',
      'index.track.trades': '청산 거래 수',
      'index.track.periodLabel': '측정 기간',
      'index.track.daysUnit': '일',
      'index.track.disclaimer': '손실을 포함한, 운용 중인 계좌 한 개(델타/감마 두 설정)의 실현 과거 실적입니다. 수익률은 입금·출금 영향을 걷어내고 계산한 시간가중수익률(TWR)입니다. 승률과 거래 수는 두 설정을 합산한 값이고, 헷지 개별 레그 기준입니다. 과거 성과·백테스트·시뮬레이션은 미래 수익을 보장하지 않으며, 원금 손실이 발생할 수 있습니다. 모든 사용자에게 동일한 도구가 제공됩니다.',
      ...
      'index.pixel.market.p': '원자재, ETF, 주식 연동, 크립토 선물이 하나의 지도 위 경로가 됩니다. 기술적인 상품 나열보다 “발견하고 싶은 시장”으로 읽히게 만듭니다.',
      ...
      'index.pixel.basis.h2': '방향을 맞히기보다<br>가격 차이를 관리',
      ...
      'index.bridge.aria': '주식·ETF로는 닿지 않는 네 가지',
      'index.bridge.label': '주식·ETF로는 닿지 않는 네 가지',
      'index.bridge.h2': '닿지 않던<br>시장·방향·시간·통화',
      'index.bridge.sub': '분산투자의 한 방법입니다<br>자산·조건·한도는 사용자가 직접 정합니다',
      'index.bridge.c1.kicker': '01 / 글로벌 분산',
      'index.bridge.c1.h3': '미국·일본·원자재까지<br>한 계좌에서.',
      'index.bridge.c1.p': 'S&P 500으로 미국을, 닛케이 ETF로 일본을 담던 방식 그대로입니다. 글로벌 자산을 한 화면에서 봅니다.',
      'index.bridge.c2.kicker': '02 / 인버스 ETF처럼',
      'index.bridge.c2.h3': '오를 때도, 내릴 때도<br>한쪽에 쏠리지 않도록.',
      'index.bridge.c2.p': '인버스 ETF로 하락에 대비하던 것과 비슷합니다. 미리 정한 조건 안에서 헷지·분산이 일어납니다.',
      'index.bridge.c3.kicker': '03 / 24시간',
      'index.bridge.c3.h3': '24시간 열린 시장,<br>새벽에 깨지 않아도 됩니다.',
      'index.bridge.c3.p': '한국 시각으로 미국 시장이 열리는 새벽, 알람을 들어도 손이 안 갑니다. 조건과 한도를 미리 정해두면, 자는 동안에도 그 안에서만 움직입니다.',
      'index.bridge.c4.kicker': '04 / 통화 분산',
      'index.bridge.c4.h3': 'USDT 기준 거래는<br>달러 자산과 비슷한 흐름.',
      'index.bridge.c4.p': 'USDT는 미국 달러에 페그된 스테이블코인입니다. USDT로 보유한 자산은 달러 가격 흐름을 따라가므로, 원화 외 통화 단위로 자산을 다루는 한 방법이 됩니다. 페그는 발행사 신뢰에 따라 변동될 수 있어요.',

      'index.portfolio.label': '더 넓은 시장',
      'index.portfolio.h2': '익숙한 시장만 보지 않아도 돼요.<br>같은 조건으로 정리할 수 있어요.',
      'index.portfolio.sub': '금, 원유, ETF·주식 연동 선물은 서로 다른 이유로 움직여요. Piano는 사용자가 직접 선택한 상품만 같은 조건 방식으로 가져와요.',
      ...
      'index.portfolio.c2.h3': '미국·한국·일본을 한 덩어리로',
      'index.portfolio.c2.p': 'ETF 연동 선물은 S&P 500, 나스닥 기술주, 한국, 일본처럼 시장 전체의 흐름을 표현할 수 있습니다. 단일 상품보다 더 넓은 시장 바구니를 전략으로 다룰 수 있습니다.',
      ...
      'index.portfolio.c4.h3': '베이시스 헷지는 여전히 핵심 전략',
      ...
      'index.inst.h2': '맞히는 것보다,<br>흔들림을 줄이는 것부터.',
      'index.inst.sub': '헤지펀드, 자산 운용사는 한 시장이나 한 방향에만 기대지 않도록 포지션을 나누고 위험을 관리합니다. Piano는 이 방식을 사용자가 정한 규칙 안에서 실행하게 돕는 도구예요. 투자 조언은 하지 않아요.',
      ...
      'index.features.label': '조건 안에서 하는 일',
      'index.features.h2': '같은 흐름 안에서<br>작동하는 세 가지 기능',
      'index.features.sub': '설정 후에는 조건 확인, 비율 이탈 보정, 규칙 기반 실행이 모두 사용자가 정한 범위 안에서만 작동합니다.',
      ...
      'index.hiw.h2': '머릿속 규칙을 자동 실행으로',
      'index.hiw.sub': '자산을 고르고, 조건과 한도를 정한 뒤, 그 범위 안에서만 실행을 활성화합니다.',
      'index.hiw.s1.time': '선택',
      'index.hiw.s1.h3': '관심 자산을 직접 선택',
      'index.hiw.s1.p': 'Piano가 들여다볼 자산을 사용자가 직접 고릅니다. 어떤 자산이 좋다고 추천하거나 판단하지 않아요.',
      'index.hiw.s2.time': '설정',
      'index.hiw.s2.h3': '조건과 한도 만들기',
      'index.hiw.s2.p': '진입 조건, 종료 조건, 위험 한도, 포지션 사이즈를 정합니다. 조건 필터는 사용자가 정한 규칙의 충족 여부만 확인합니다.',
      'index.hiw.s3.time': '실행',
      'index.hiw.s3.h3': '정한 범위 안에서 실행과 보정',
      'index.hiw.s3.p': 'API 권한 승인 후, Piano는 설정된 조건 안에서 모니터링·주문·비율 보정을 수행합니다. 실행 이력은 대시보드에서 확인합니다.',
      ...
      'index.sec.c5.h3': '조건은 본인이 결정',
      'index.sec.c5.p': '모든 조건은 본인이 직접 정하고 언제든 바꿀 수 있어요',
      'index.sec.c6.h3': '격리 환경',
      'index.sec.c6.p': '사용자마다 분리된 환경에서 운영됩니다',
      ...
      'index.pricing.note': '운영 환경에 따라 요금이 달라져 별도로 안내드립니다.',
      ...
      'index.faq.q5.a': 'Piano는 바이낸스 연동 상품을 중심으로, 가상자산 시장과 원자재, ETF 연동 지수, 일부 글로벌 주식 가격을 추종하는 선물을 다룹니다. 이는 기초자산을 직접 보유하는 것이 아닌 파생상품이며, 상품 제공 범위는 거래소 제공 여부와 사용자 승인 범위에 따라 달라집니다.',
