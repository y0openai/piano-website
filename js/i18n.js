...
(function () {
  ...
  const T = {
    en: {
      ...
      // ---------- index.html ----------
      'index.title': 'PIANO — Automated Hedge Balancing for Crypto',
      'index.metaDesc': 'Automatically balance your hedge positions. A tool that maintains the spot-to-futures ratio based on your configured parameters.',

      'index.hero.badge': 'Automated Hedge Balancing',
      'index.hero.h1': 'Keep your hedge<br>in balance,<br>automatically.',
      'index.hero.sub': 'No need to monitor 24/7. A tool that maintains the spot-to-futures ratio based on your configured parameters.',
      'index.hero.ctaPrimary': 'Get Started →',
      'index.hero.ctaSecondary': 'How It Works',
      'index.hero.figCaption': 'AI manages ratios across symbols. Exits when conditions turn favorable.',

      'index.features.label': 'Core Features',
      'index.features.h2': 'Three mechanisms that<br>keep your hedge intact',
      'index.features.sub': 'Built on freqtrade open-source framework. Every execution respects boundaries you define.',
      ...
      'index.features.f2.p': 'When market movements drift the spot·futures ratio, AI evaluates in real time and adjusts positions to restore balance.',
      ...
      'index.features.f3.p': 'AI monitors the market and dynamically manages the position size ratio between both directions. When conditions turn favorable, positions are closed to realize profit.',
      ...
      'index.hiw.s2.p': 'Configure rebalancing conditions and position size. You can adjust any parameter at any time.',
      'index.hiw.s3.time': 'Ongoing',
      'index.hiw.s3.h3': 'Monitor',
      'index.hiw.s3.p': 'Piano manages position balance automatically. Check status and execution history on the dashboard.',
      ...
      'index.sec.do.li1': 'Automatically maintains hedge ratios',
      'index.sec.do.li2': 'Automatically corrects position imbalances',
      ...
      'index.faq.q1.a': "Piano is a tool that automatically maintains the balance of spot+futures hedge (Basis Hedge) positions on Binance. It's built on the freqtrade open-source framework.",
      'index.faq.q2.q': 'Do I need crypto trading experience?',
      'index.faq.q2.a': 'A basic understanding of Basis Hedge structures and Binance futures trading is required. Piano automates maintenance and management of hedge positions — it does not make trading decisions for you.',
      ...
      'index.faq.q4.q': 'Does Piano invest on my behalf?',
      'index.faq.q4.a': 'No. Piano only executes within the boundaries you configure. It does not make autonomous investment decisions or guarantee any returns.',
      'index.faq.q5.q': 'Which exchanges are supported?',
      'index.faq.q5.a': 'Currently Binance spot + futures. EWY perpetual futures (Korean equity index) is also supported. See <a href="ewy.html" style="color:#888;text-decoration:underline">EWY page</a> for details.',

      'index.cta.h2': 'Start automating your hedge today',
      'index.cta.sub': 'Connect via Telegram and get set up in minutes.',
      ...
      'index.risk.i3': "<strong>3. Piano does not make investment decisions on your behalf.</strong> — All trades are executed according to user-configured conditions. Decisions regarding timing, asset selection, and trade size are solely the user's responsibility.",
      ...
      'index.risk.body': "Cryptocurrency trading involves significant risk and may result in the complete loss of principal. All trades are conducted at the user's own judgment and responsibility. Before making any investment decisions, carefully consider your financial situation, investment experience, and risk tolerance.",
      ...
      'ewy.full.p3': '<strong style="color:#EDEDED">3. Piano does not make investment decisions on your behalf.</strong> — All trades are executed according to user-configured conditions.',
    ...
    ko: {
      ...
      // ---------- index.html ----------
      'index.title': 'PIANO — 암호화폐 헷지 자동 밸런싱',
      'index.metaDesc': '헷지 포지션의 균형을 자동으로 유지합니다. 사용자가 설정한 조건에 따라 현물·선물 비율을 관리하는 소프트웨어 도구입니다.',

      'index.hero.badge': '헷지 자동 밸런싱',
      'index.hero.h1': '헷지 균형을<br>자동으로<br>유지합니다.',
      'index.hero.sub': '24시간 직접 모니터링할 필요 없이, 사용자가 설정한 조건에 따라 현물·선물 비율을 유지하는 도구입니다.',
      'index.hero.ctaPrimary': '시작하기 →',
      'index.hero.ctaSecondary': '작동 방식',
      'index.hero.figCaption': 'AI가 종목별 비율을 관리하고, 조건이 유리할 때 청산합니다.',

      'index.features.label': '핵심 기능',
      'index.features.h2': '헷지를 지키는<br>세 가지 메커니즘',
      'index.features.sub': 'freqtrade 오픈소스 프레임워크 기반. 모든 실행은 사용자가 정한 경계 안에서만 이루어집니다.',
      ...
      'index.features.f2.p': '시장 움직임으로 현물·선물 비율이 이탈하면 AI가 실시간으로 평가하고 포지션을 조정해 균형을 복원합니다.',
      'index.features.f2.note': '리밸런싱 / AI 보정',
      'index.features.f3.caption': 'AI가 사이즈 비율을 조정하고 유리한 포지션을 청산합니다.',
      'index.features.f3.h3': '연동 밸런싱',
      'index.features.f3.p': 'AI가 시장을 모니터링하면서 양방향 포지션 사이즈 비율을 동적으로 관리합니다. 조건이 유리해지면 포지션을 청산해 수익을 실현합니다.',
      ...
      'index.hiw.s2.p': '리밸런싱 조건과 포지션 사이즈를 설정합니다. 모든 파라미터는 언제든 변경할 수 있습니다.',
      'index.hiw.s3.time': '운영',
      'index.hiw.s3.h3': '모니터링',
      'index.hiw.s3.p': 'Piano가 포지션 균형을 자동으로 관리합니다. 상태와 실행 이력은 대시보드에서 확인하세요.',
      ...
      'index.sec.do.li1': '헷지 비율을 자동으로 유지합니다',
      'index.sec.do.li2': '포지션 불균형을 자동으로 보정합니다',
      ...
      'index.faq.q1.a': 'Piano는 바이낸스에서 현물+선물 헷지(베이시스 헷지) 포지션의 균형을 자동으로 유지하는 도구입니다. freqtrade 오픈소스 프레임워크 위에 구축되었습니다.',
      'index.faq.q2.q': '암호화폐 거래 경험이 필요한가요?',
      'index.faq.q2.a': '베이시스 헷지 구조와 바이낸스 선물 거래에 대한 기본적인 이해가 필요합니다. Piano는 헷지 포지션의 유지·관리를 자동화할 뿐, 거래 결정을 대신해 주지 않습니다.',
      'index.faq.q3.q': '자산은 안전한가요?',
      'index.faq.q3.a': '자금은 항상 사용자의 바이낸스 계정에 보관됩니다. Piano는 출금 권한이 없는 API 키만 사용합니다. API 키를 해지하면 즉시 접근이 차단됩니다.',
      'index.faq.q4.q': 'Piano가 대신 투자해 주나요?',
      'index.faq.q4.a': '아니요. Piano는 사용자가 설정한 경계 안에서만 실행됩니다. 자율적인 투자 결정을 하지 않으며 수익을 보장하지도 않습니다.',
      'index.faq.q5.q': '어떤 거래소를 지원하나요?',
      'index.faq.q5.a': '현재 바이낸스 현물 + 선물을 지원합니다. EWY 무기한선물(한국 주가지수)도 지원합니다. 자세한 내용은 <a href="ewy.html" style="color:#888;text-decoration:underline">EWY 페이지</a>를 참고하세요.',

      'index.cta.h2': '오늘부터 헷지를 자동화하세요',
      'index.cta.sub': '텔레그램으로 연결하면 몇 분 안에 설정할 수 있습니다.',
      'index.cta.btn': '시작하기 →',
      ...
      'index.risk.i3': '<strong>3. Piano는 사용자를 대신해 투자 결정을 하지 않습니다.</strong> — 모든 거래는 사용자가 설정한 조건에 따라 실행됩니다. 매매 시점·종목·규모에 대한 결정은 전적으로 사용자 책임입니다.',
      'index.risk.i4': '<strong>4. Piano는 수익을 보장하지 않습니다.</strong> — 과거 성과, 백테스트, 시뮬레이션 결과는 향후 수익을 보장하지 않습니다.',
      'index.risk.sub2': '투자 위험 고지',
      'index.risk.body': '암호화폐 거래는 상당한 위험을 수반하며 원금 전액 손실 가능성이 있습니다. 모든 거래는 사용자 본인의 판단과 책임 하에 이루어집니다. 투자 결정 전 본인의 재정 상황, 투자 경험, 위험 감내 수준을 신중히 고려하세요.',
      ...
      'ewy.full.p3': '<strong style="color:#EDEDED">3. Piano는 사용자를 대신해 투자 결정을 하지 않습니다.</strong> — 모든 거래는 사용자가 설정한 조건에 따라 실행됩니다.',
