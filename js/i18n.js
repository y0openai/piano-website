...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.track.roi': 'Return (on deployed capital)',
      ...
      'index.track.disclaimer': 'These are realized past results of a single running configuration (gamma), losses included. Return is measured against deployed capital (cumulative margin), and win rate counts individual hedge legs. Past performance, backtests, and simulations do not guarantee future returns, and you may lose principal. The same tool is provided to every user.',
    ...
    ko: {
      ...
      'index.track.roi': '수익률 (투입자본 대비)',
      'index.track.winrate': '승률',
      'index.track.trades': '청산 거래 수',
      'index.track.periodLabel': '측정 기간',
      'index.track.daysUnit': '일',
      'index.track.disclaimer': '손실을 포함한, 운용 중인 한 설정(감마)의 실현 과거 실적입니다. 수익률은 투입 자본(누적 마진) 대비이며, 승률은 헷지 개별 레그 기준입니다. 과거 성과·백테스트·시뮬레이션은 미래 수익을 보장하지 않으며, 원금 손실이 발생할 수 있습니다. 모든 사용자에게 동일한 도구가 제공됩니다.',
