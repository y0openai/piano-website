...
(function () {
  ...
  const T = {
    ...
    ko: {
      ...
      'index.track.disclaimer': '손실을 포함한, 운용 중인 계좌 한 개(델타/감마 두 설정)의 실현 과거 실적입니다. 수익률은 측정 기간 중 계좌 순자산의 변화이며 입출금 영향은 제외했습니다. 승률과 거래 수는 두 설정을 합산한 값이고, 헷지 개별 레그 기준입니다. 과거 성과·백테스트·시뮬레이션은 미래 수익을 보장하지 않으며, 원금 손실이 발생할 수 있습니다. 모든 사용자에게 동일한 도구가 제공됩니다.',
