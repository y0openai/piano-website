...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.metaDesc': 'Turn crypto futures automation into a broader market strategy layer across gold, oil, ETFs, AI stock-linked flows, and crypto-linked futures. Piano automates signal analysis and execution within user-defined conditions.',

      'index.hero.badge': 'Market Strategy Automation',
      'index.hero.h1': 'Turn crypto automation<br>into a global market<br>strategy.',
      'index.hero.sub': 'From crypto futures to gold, oil, QQQ, and AI stock-linked flows. Piano analyzes market signals and executes only within the conditions you set.',
      'index.hero.ctaPrimary': 'Plan a Strategy →',
      'index.hero.ctaSecondary': 'See How It Works',
      'index.hero.figCaption': 'Your rules coordinate exposure across supported markets.',
      'index.marquee.aria': 'Supported market examples',
      'index.marquee.lead': 'Gold, oil, ETFs, AI stocks, and crypto-linked names on one strategy radar',
      ...
      'index.portfolio.c2.p': 'ETF-linked futures can express the flow of a broad market: U.S. large caps, Nasdaq tech, Korea, Japan, and other supported regions. One rule can watch a market basket instead of one coin.',
      'index.portfolio.c3.kicker': '03 / Big Themes',
      'index.portfolio.c3.h3': 'AI, chips, and crypto-linked equities',
      'index.portfolio.c3.p': 'Selected stock-linked futures can reflect attention around big tech, AI semiconductors, electric vehicles, or crypto-linked companies. Availability changes by exchange, so Piano keeps execution inside supported instruments.',
      ...
      'index.inst.label': 'Institutional Logic',
      'index.inst.h2': 'Professionals manage exposure<br>before they chase returns',
      'index.inst.sub': 'Hedge funds, asset managers, and market-making desks use futures and derivatives to diversify, hedge, and manage risk. Piano brings that operating logic into user-defined rule automation, without providing investment advice or return promises.',
      'index.inst.c1.kicker': '01 / Diversify',
      'index.inst.c1.h3': 'Do not depend on one market',
      'index.inst.c1.p': 'Gold, oil, ETF-linked indices, stock-linked futures, and crypto can react to different drivers. Looking across markets is a basic risk-management habit in professional portfolios.',
      ...
      'index.hiw.h2': 'Structure your strategy<br>in three steps',
      'index.hiw.sub': 'Define the target markets, limits, and execution rules before activation.',
      ...
      'index.hiw.s3.p': 'Piano runs your defined conditions automatically. Check status and execution history on the dashboard.',
      ...
      'index.faq.q1.a': 'Piano is a software tool that analyzes market signals and automates execution for user-defined strategies across supported crypto futures and market-linked futures. Hedge balancing is one supported strategy structure.',
    ...
    ko: {
      ...
      'index.marquee.lead': '금, 원유, ETF, AI 주식, 크립토 연계 종목까지 하나의 전략 레이더로',
      ...
      'index.portfolio.c2.h3': '미국장·한국장·일본장을 한 덩어리로',
      'index.portfolio.c2.p': 'ETF 연동 선물은 S&P 500, 나스닥 기술주, 한국, 일본처럼 시장 전체의 흐름을 표현할 수 있습니다. 하나의 코인보다 더 넓은 시장 바구니를 전략으로 다룰 수 있습니다.',
      'index.portfolio.c3.kicker': '03 / 큰 테마',
      'index.portfolio.c3.h3': 'AI, 반도체, 크립토 연계 주식 흐름',
      'index.portfolio.c3.p': '일부 주식 연동 선물은 빅테크, AI 반도체, 전기차, 크립토 연계 기업에 대한 시장 관심을 반영합니다. 지원 상품은 거래소 제공 범위에 따라 달라지며, Piano는 지원되는 상품 안에서만 실행합니다.',
      ...
      'index.inst.label': '기관 투자자의 관점',
      'index.inst.h2': '전문가들은 수익보다<br>노출을 먼저 관리합니다',
      'index.inst.sub': '헤지펀드, 자산운용사, 펀드 매니저, 마켓메이커는 선물·파생상품을 분산, 헷지, 리스크 관리 수단으로 사용합니다. Piano는 그 원리를 투자 조언이 아니라 사용자가 정한 규칙 기반 자동 실행 구조로 옮깁니다.',
      ...
      'index.hiw.h2': '세 단계로<br>전략 구성',
      'index.hiw.sub': '대상 시장, 위험 한도, 실행 조건을 정한 뒤 자동화 구조를 활성화합니다.',
      ...
      'index.hiw.s3.p': 'Piano가 사용자가 정한 조건을 자동으로 실행합니다. 상태와 실행 이력은 대시보드에서 확인하세요.',
      ...
      'index.faq.q1.a': 'Piano는 지원되는 가상자산 선물과 시장 연동 선물에서 사용자가 정한 전략의 시장 신호 분석과 매매 실행을 자동화하는 소프트웨어입니다. 헷지 밸런싱은 지원되는 전략 구조 중 하나입니다.',
