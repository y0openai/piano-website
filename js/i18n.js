...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.bridge.aria': 'Crypto next to your ETFs',
      'index.bridge.label': 'Crypto next to your ETFs',
      'index.bridge.h2': 'If you have used stocks and ETFs,<br>here is one way to see it.',
      'index.bridge.sub': 'One way to diversify. You set the assets, conditions, and limits.',
    ...
    ko: {
      ...
      'index.bridge.aria': 'ETF 옆의 가상자산',
      'index.bridge.label': 'ETF 옆의 가상자산',
      'index.bridge.h2': '주식·ETF를 해봤다면<br>이렇게 보세요.',
      'index.bridge.sub': '분산투자의 한 방법입니다. 자산·조건·한도는 사용자가 직접 정합니다.',
