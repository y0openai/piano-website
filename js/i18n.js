...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.pixel.garden.h3': 'Different drivers, one risk view',
    ...
    ko: {
      ...
      'index.pixel.garden.label': '올웨더 관점',
      'index.pixel.garden.h3': '서로 다른 움직임을 하나의 리스크 시야로',
      'index.pixel.garden.p': '금, 원유, ETF, AI 주식, 크립토는 서로 다른 힘에 반응합니다. 가든 장면은 분산 투자의 원리를 편안하고 기억에 남는 이야기로 바꿉니다.',
      'index.pixel.basis.label': '베이시스 헷지 워크샵',
      'index.pixel.basis.h2': '스프레드를<br>눈에 보이게',
      'index.pixel.basis.p': '워크샵 장면은 과장 없이 핵심을 보여줍니다. 현물과 선물 다리가 함께 움직이고, 스프레드를 측정하며, 사용자가 정한 조건 안에서만 실행됩니다.',
      'index.pixel.basis.tag1': '현물 다리',
      'index.pixel.basis.tag2': '선물 다리',
      'index.pixel.basis.tag3': '스프레드 게이트',
