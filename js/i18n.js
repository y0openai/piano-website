...
(function () {
  ...
  const T = {
    en: {
      ...
      'index.metaDesc': 'Automate market signal analysis and execution for approved strategies across crypto futures and market-linked futures that track gold, oil, ETFs, and selected global stocks.',

      'index.hero.badge': 'Algorithmic Strategy Automation',
      'index.hero.h1': 'Automate your<br>approved market<br>strategy.',
      'index.hero.sub': 'Piano analyzes market signals and executes approved strategies across supported crypto futures and market-linked futures that track gold, oil, major ETFs, and selected global stocks.',
      ...
      'index.portfolio.sub': 'The interesting part is simple: some Binance-connected futures can track familiar real-world markets without buying the asset itself. Gold when fear rises, oil when inflation moves, broad ETFs when markets rotate, and AI-chip stocks when tech leads. Piano turns supported markets into rules you approve and monitor.',
      ...
      'index.portfolio.c3.p': 'Selected stock-linked futures can reflect attention around big tech, AI semiconductors, electric vehicles, or crypto-linked companies. Availability changes by exchange, so Piano keeps execution inside approved instruments.',
      'index.portfolio.c4.kicker': '04 / Basis Hedge',
      'index.portfolio.c4.h3': 'Basis hedge as a core edge',
      'index.portfolio.c4.p': "Piano is not only about guessing direction. Basis hedge remains a core edge: monitoring spot-futures or related market spreads, correcting drift, and executing only within user-approved conditions.",
      ...
      'index.faq.q1.a': 'Piano is a software tool that analyzes market signals and automates execution for user-approved strategies across supported crypto futures and market-linked futures. Hedge balancing is one supported strategy structure.',
    ...
    ko: {
      ...
      'index.metaDesc': '가상자산 선물과 금, 원유, 주요 ETF, 일부 글로벌 주식 가격을 추종하는 시장 연동 선물에서 사용자가 승인한 전략의 신호 분석과 실행을 자동화합니다.',

      'index.hero.badge': '알고리즘 기반 전략 자동화',
      'index.hero.h1': '승인한 시장 전략을<br>자동으로<br>실행합니다.',
      'index.hero.sub': 'Piano는 가상자산 선물뿐 아니라 금, 원유, 주요 ETF, 일부 글로벌 주식 가격을 추종하는 지원 선물에서 시장 신호를 분석하고 승인된 전략을 자동 실행합니다.',
      ...
      'index.portfolio.sub': '핵심은 간단합니다. 코인 선물 인프라 안에서 실제 금을 사거나 미국 주식을 직접 보유하지 않아도, 금·원유·미국 대표 ETF·한국/일본 증시·AI 반도체 주식의 가격 흐름을 추종하는 상품을 전략 대상으로 볼 수 있습니다. Piano는 이런 시장을 사용자가 승인한 규칙으로 묶고 모니터링합니다.',
      ...
      'index.portfolio.c3.p': '일부 주식 연동 선물은 빅테크, AI 반도체, 전기차, 크립토 연계 기업에 대한 시장 관심을 반영합니다. 지원 상품은 거래소 제공 범위에 따라 달라지며, Piano는 승인된 상품 안에서만 실행합니다.',
      'index.portfolio.c4.kicker': '04 / 베이시스 헷지',
      'index.portfolio.c4.h3': '핵심 엣지로 유지되는 베이시스 헷지',
      'index.portfolio.c4.p': 'Piano는 방향을 맞히는 전략만 다루지 않습니다. 베이시스 헷지는 핵심 엣지로 유지됩니다. 현물·선물 또는 관련 시장의 스프레드를 모니터링하고, 비율 이탈을 보정하며, 사용자가 승인한 조건 안에서만 실행합니다.',
      ...
      'index.faq.q1.a': 'Piano는 지원되는 가상자산 선물과 시장 연동 선물에서 사용자가 승인한 전략의 시장 신호 분석과 매매 실행을 자동화하는 소프트웨어입니다. 헷지 밸런싱은 지원되는 전략 구조 중 하나입니다.',
